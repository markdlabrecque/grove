...
4. **Action Button binding**: `CaptureViaDictationIntent` (AppIntent, donated via `GroveShortcutsProvider`) appears in the Shortcuts picker and the Action Button settings panel. User binds it once in Settings → Action Button → Shortcut. (#326)
